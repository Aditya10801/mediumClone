                ...
                <div className="mb-8 flex flex-col gap-4 rounded-[2rem] border border-slate-200 bg-white p-10 shadow-xl sm:p-12">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-900">Sign in to your account</h1>
                            <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
                                Access your dashboard, publish stories, and keep track of your favorite reads.
                            </p>
                        </div>
                        <Link
                            to="/signup"
